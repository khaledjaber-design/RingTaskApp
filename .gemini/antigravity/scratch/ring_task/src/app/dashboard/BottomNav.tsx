...
export default function BottomNav() {
    ...
    return (
        <>
            <div className="absolute bottom-0 left-0 w-full h-[85px] bg-white border-t border-gray-100 flex items-center justify-around px-2 rounded-b-[2.5rem] shadow-[0_-4px_20px_rgba(0,0,0,0.03)] z-50">
                ...
                <Link href="/dashboard/calendar" className="flex flex-col items-center gap-1 min-w-[60px]">
                    ...
                    <span className="text-[10px] font-semibold text-[#94a3b8]">Calendar</span>
                </Link>
                ...
                <Link href="/dashboard/alerts" className="flex flex-col items-center gap-1 min-w-[60px]">
                    ...
                    <span className="text-[10px] font-semibold text-[#94a3b8]">Alerts</span>
                </Link>
                ...
                <Link href="/dashboard/profile" className="flex flex-col items-center gap-1 min-w-[60px]">
                    ...
                    <span className="text-[10px] font-semibold text-[#94a3b8]">Profile</span>
                </Link>
