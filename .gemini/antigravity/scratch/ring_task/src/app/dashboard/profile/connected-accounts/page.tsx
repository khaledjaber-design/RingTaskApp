...
export default function ConnectedAccounts() {
    ...
    return (
        <div className="flex flex-col min-h-full bg-[#0f172a] w-full relative px-5 pt-8 pb-10">
            ...
            <div className="flex items-center justify-between mb-8 z-10 w-full bg-[#0f172a]">
                ...
                <h1 className="text-[20px] font-extrabold text-white tracking-tight">Connected Accounts</h1>
                <button
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="bg-[#14342b] rounded-[1.2rem] p-5 mb-2">
                    <h2 className="font-extrabold text-white text-[16px] mb-1">0 of 4 connected</h2>
                    <p className="text-[#a0b8b1] text-[13px] font-medium">Sync calendars and meetings</p>
                </div>

                {/* Integration Cards */}
                <div className="bg-[#1e293b] rounded-[1.2rem] p-5 shadow-sm flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-white text-[15px]">Apple Calendar</span>
                            <span className="text-gray-400 text-[12px] font-medium mt-0.5">Not connected</span>
                        </div>
                    </div>
                ...
                <div className="bg-[#1e293b] rounded-[1.2rem] p-5 shadow-sm flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-white text-[15px]">Google Calendar</span>
                            <span className="text-gray-400 text-[12px] font-medium mt-0.5">Not connected</span>
                        </div>
                    </div>
                    <button className="px-5 py-2 bg-[#20c997] text-white font-bold text-[13px] rounded-full hover:bg-[#1bb889] transition-colors shadow">
                ...
                <div className="bg-[#1e293b] rounded-[1.2rem] p-5 shadow-sm flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-white text-[15px]">Outlook & Teams</span>
                            <span className="text-gray-400 text-[12px] font-medium mt-0.5">Not connected</span>
                        </div>
                    </div>
                    <button className="px-5 py-2 bg-[#20c997] text-white font-bold text-[13px] rounded-full hover:bg-[#1bb889] transition-colors shadow">
