                ...
                <div className="flex flex-col gap-6">
                            ...
                            {mounted && (
                                <>
                                    <button
                                        ...
                                        className={`flex-1 rounded-xl flex items-center justify-center gap-2 font-bold text-[14px] transition-colors ${theme === "light" ? "border-2 border-[#20c997] text-[#20c997]" : "bg-[#1e293b] text-gray-400 border border-transparent"}`}
                                    >
                                    ...
                                    <button
                                        onClick={() => {
                                            setTheme("dark");
                                            // Ensure the HTML class is toggled explicitly
                                            document.documentElement.classList.add('dark');
                                        }}
                                        className={`flex-1 rounded-xl flex items-center justify-center gap-2 font-bold text-[14px] transition-colors ${theme === "dark" ? "border-2 border-[#20c997] text-[#20c997]" : "bg-[#1e293b] text-gray-400 border border-transparent"}`}
                                    >
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                        ...
                        <div className="bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-transparent rounded-[1.5rem] flex flex-col p-2 transition-colors duration-200">
                            ...
                            <div className="flex items-center justify-between p-4">
                                <span className="font-bold text-black dark:text-white text-[15px]">Sound</span>
                                <button
                    ...
                    <div className="flex flex-col gap-3 mt-4">
                        ...
                        <div className="bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-transparent rounded-[1.2rem] flex flex-col p-2 transition-colors duration-200">
                            ...
                            <Link href="#" className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700/50">
                                <span className="font-bold text-black dark:text-white text-[15px]">Change Password</span>
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400 dark:text-gray-500">
                                    <polyline points="9 18 15 12 9 6"></polyline>
                                </svg>
                            </Link>

                            <button onClick={() => setIsLogoutModalOpen(true)} className="flex items-center justify-between p-4 transition hover:bg-gray-200 dark:hover:bg-gray-700/30 rounded-b-xl">
