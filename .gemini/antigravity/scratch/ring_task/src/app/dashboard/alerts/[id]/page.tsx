    ...
    return (
        <div className="flex flex-col min-h-full bg-[#f8fafc] w-full relative px-5 pt-8 pb-10">
            ...
            <div className="flex items-center justify-between mb-10">
                ...
                <h1 className="text-[20px] font-extrabold text-[#0f172a] tracking-tight">Notification</h1>
                <button
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <span className="text-[#20c997] text-[12px] font-extrabold uppercase tracking-wider block mb-0.5">Task Reminder</span>
                        <span className="text-[#64748b] text-[13px] font-medium leading-tight">1:30 PM</span>
                    </div>
                </div>

                {/* Notification Main Card */}
                <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100">
                    <h2 className="font-extrabold text-[#0f172a] text-[18px] mb-3">Team Meeting in 30 minutes</h2>
                    <p className="text-[#475569] text-[15px] leading-relaxed font-medium">Your team meeting starts at 2:00 PM. Tap to review agenda.</p>
                </div>

                {/* Related Task Link */}
                <div className="bg-white rounded-[1.5rem] p-5 shadow-sm border border-gray-100 flex flex-col gap-3">
                    <span className="text-[#64748b] text-[11px] font-bold uppercase tracking-wider px-1">Related Task</span>
                    <div className="flex items-center gap-3 px-1">
                        <div className="w-3 h-3 rounded-full bg-[#20c997] shrink-0"></div>
                        <div className="flex flex-col">
                            <span className="font-semibold text-[#0f172a] text-[15px]">Team Meeting</span>
                            <span className="text-[#64748b] text-[13px] font-medium mt-0.5">Scheduled - 1:30 PM</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="mt-auto pt-8 grid grid-cols-2 gap-3 pb-4">
                ...
                <button onClick={() => router.back()} className="h-12 bg-white text-[#0f172a] rounded-xl font-bold text-[14px] flex justify-center items-center gap-2 border border-gray-200 hover:bg-gray-50 shadow-sm transition">
                ...
                <button onClick={() => router.back()} className="h-12 bg-white text-[#64748b] rounded-xl font-bold text-[14px] flex justify-center items-center gap-2 border border-gray-200 hover:bg-gray-50 shadow-sm transition">
